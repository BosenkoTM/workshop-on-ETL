...
| **4** | **SQL**: Напишите запрос для получения среднего числа просмотров по часам для сайта **Yandex** | Напишите SQL-запрос для подсчета среднего числа просмотров по часам для сайта Yandex. Визуализируйте результаты на графике для удобства анализа. |
| **5** | **Визуализация**: Постройте график для отображения средних значений просмотров по часам для сайтов **Yandex**, **VK**, **Mail.ru** | Постройте график для отображения средних значений просмотров по часам для данных сайтов, используя информацию, сохраненную в базе данных. |
...
| **9** | **SQL**: Напишите запрос для подсчета максимальных просмотров по часам для сайта **Ozon** | Напишите SQL-запрос для получения максимального числа просмотров по часам для сайта Ozon. Постройте график, чтобы наглядно представить данные. |
| **10** | **Визуализация**: Постройте график для отображения числа просмотров по каждому часу для сайта **Sberbank** | Постройте график для отображения числа просмотров по каждому часу для сайта **Sberbank** на основе сохраненных данных. |
...
| **14** | **SQL**: Напишите запрос для получения среднего числа просмотров по часам для всех сайтов | Напишите SQL-запрос для подсчета среднего числа просмотров по часам для всех сайтов. Визуализируйте результаты для анализа. |
| **15** | **Визуализация**: Постройте график, который отображает топ-5 сайтов по числу просмотров за последний месяц | Постройте график, который отображает топ-5 сайтов по числу просмотров за последний месяц на основе данных, полученных через Airflow. |
...
| **19** | **SQL**: Напишите запрос для подсчета просмотров для всех страниц за последние 24 часа | Напишите SQL-запрос, который будет выводить количество просмотров для всех страниц за последние 24 часа. Постройте график с результатами. |
...
| **24** | **SQL**: Напишите запрос для вычисления медианы просмотров по часам для каждой страницы | Напишите SQL-запрос для вычисления медианы числа просмотров по часам для каждой страницы и визуализируйте результаты. |
| **25** | **Визуализация**: Постройте график, сравнивающий количество просмотров по дням для страниц **VK** и **Sberbank** | Постройте график, сравнивающий количество просмотров по дням для страниц **VK** и **Sberbank** с использованием SQL-запросов и визуализации. |
...
| **29** | **SQL**: Напишите запрос для получения данных по всем сайтам за последний час | Напишите SQL-запрос, который будет выводить данные по всем сайтам за последний час. Постройте график с результатами. |
| **30** | **Визуализация**: Постройте график, который отображает среднее количество просмотров по всем сайтам за последние 30 дней | Постройте график, который отображает среднее количество просмотров по всем сайтам за последние 30 дней. |
