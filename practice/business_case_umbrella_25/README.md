...
- `real_umbrella.py` - `DAG`, иллюстрирующий вариант использования бизнес кейса "Umbrella", который автоматизирует весь pipeline обработки данные о продажах  и погодных условиях, модель машинного обучения.
...
| 20 | Получить прогноз в Москве на 7 дней | Добавить столбец: "день недели" | Построить график температура по дням недели |
